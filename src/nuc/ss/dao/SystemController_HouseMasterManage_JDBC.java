...
public class SystemController_HouseMasterManage_JDBC {
    public static ArrayList searchHouseMaster() {
    ...
    public static boolean deleteHouseMaster(String tid) {
        ArrayList<HouseMaster> houseMasterslist = new ArrayList<HouseMaster>();
        String id = null;//工号
        String password = null;
        String name = null; //姓名
    ...
    public static boolean updateSetHouseMaster(String val, String tid, ArrayList<String> tableHeadList, int column) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        try {
            Class.forName("com.mysql.jdbc.Driver");
