...
public class StudentLoginFrame extends JFrame{
	 ...
	 public static JPanel t = new JPanel();
	    ...
	    public void init(String username) throws ClassNotFoundException, SQLException {
	    	...
	    	t_dormitoryId = new JLabel(SystemController_Student_Controller.student(username).getApartmentId());
	    	t_dormitoryBudingId = new JLabel(SystemController_Student_Controller.student(username).getDormitoryId());
