...
public class StudentLoginFrame extends JFrame {
    private JLabel l_id, l_name, l_sex, l_grade, l_apartmentId, l_dormitoryId, l_bed, l_phoneNumber, t_id, t_name, t_sex, t_grade, t_apartmentId, t_dormitoryId, t_bed, t_phoneNumber;
    ...
    public void init(String username) throws ClassNotFoundException, SQLException {
        ...
        t_apartmentId = new JLabel(SystemController_Student_Controller.student(username).getApartmentId());
        ...
        p5.add(l_apartmentId);
        p5.add(t_apartmentId);
